...
2. Download `noTunesMute.zip`.
3. Unzip and drag `noTunes.app` to your `Applications` folder.

> Important: this app is ad-hoc signed (not notarized), because there is no paid Apple Developer account/certificate.
>
...
```text
Ad-hoc signed macOS build of noTunesMute <VERSION> (not notarized).
...
Install:
1. Download and unzip noTunesMute.zip
